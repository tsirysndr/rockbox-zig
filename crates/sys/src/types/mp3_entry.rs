...
impl From<crate::Mp3Entry> for Mp3Entry {
    fn from(entry: crate::Mp3Entry) -> Self {
        Self {
            ...
            id3v2len: entry.id3v2len as u64,
            id3v1len: entry.id3v1len as u64,
            first_frame_offset: entry.first_frame_offset as u64,
            filesize: entry.filesize as u64,
            length: entry.length as u64,
            elapsed: entry.elapsed as u64,
            lead_trim: entry.lead_trim,
            tail_trim: entry.tail_trim,
            samples: entry.samples,
            frame_count: entry.frame_count as u64,
            bytesperframe: entry.bytesperframe as u64,
            vbr: entry.vbr,
            ...
            tagcache_idx: entry.tagcache_idx as i64,
            rating: entry.rating,
            score: entry.score,
            playcount: entry.playcount as i64,
            lastplayed: entry.lastplayed as i64,
            playtime: entry.playtime as i64,
            track_level: entry.track_level as i64,
            album_level: entry.album_level as i64,
            track_gain: entry.track_gain as i64,
            album_gain: entry.album_gain as i64,
            track_peak: entry.track_peak as i64,
            album_peak: entry.album_peak as i64,
