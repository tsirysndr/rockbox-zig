...
async_handler!(playlists, get_playlists);
async_handler!(playlists, delete_playlist);
async_handler!(playlists, update_playlist);
async_handler!(playlists, play_playlist);
async_handler!(folders, create_folder);
async_handler!(folders, get_folder);
async_handler!(folders, get_folders);
async_handler!(folders, update_folder);
async_handler!(folders, delete_folder);
