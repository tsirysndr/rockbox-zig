...
use gpui::{
    App, Context, Entity, FontWeight, IntoElement, InteractiveElement, ParentElement,
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    ...
                                    .on_click(|_, _, cx: &mut App| {
                                        ...
                                        state.update(cx, |s: &mut crate::state::AppState, _| s.toggle_shuffle());
                                    })
                            ...
                            .child(
                                div()
                                    ...
                                    .on_click(|_, _, cx: &mut App| {
                                        let state = cx.global::<Controller>().state.clone();
                                        state.update(cx, |s: &mut crate::state::AppState, _| s.prev());
                                    })
                            ...
                            .child(
                                div()
                                    ...
                                    .on_click(|_, _, cx: &mut App| {
                                        let state = cx.global::<Controller>().state.clone();
                                        state.update(cx, |s: &mut crate::state::AppState, _| match s.status {
                            ...
                            .child(
                                div()
                                    ...
                                    .on_click(|_, _, cx: &mut App| {
                                        let state = cx.global::<Controller>().state.clone();
                                        state.update(cx, |s: &mut crate::state::AppState, _| s.next());
                                    })
                            ...
                            .child(
                                div()
                                    ...
                                    .on_click(|_, _, cx: &mut App| {
                                        let state = cx.global::<Controller>().state.clone();
                                        state.update(cx, |s: &mut crate::state::AppState, _| s.toggle_repeat());
                                    })
