...
impl IconNamed for Icons {
    fn path(self) -> SharedString {
        match self {
            ...
            Icons::Genre => "icons/genre.svg",
            Icons::WinClose => "icons/window-close.svg",
            Icons::WinMinimize => "icons/window-minimize.svg",
            Icons::WinMaximize => "icons/window-maximize.svg",
            Icons::WinRestore => "icons/window-restore.svg",
