...
let sampleSongs: [Song] = [
    Song(cuid: "", title: "Bohemian Rhapsody", artist: "Queen", album: "A Night at the Opera", albumArt: nil, duration: 354, color: .purple),
    Song(cuid: "", title: "You're My Best Friend", artist: "Queen", album: "A Night at the Opera", albumArt: nil, duration: 170, color: .purple),
    Song(cuid: "", title: "Love of My Life", artist: "Queen", album: "A Night at the Opera", albumArt: nil, duration: 219, color: .purple),
    Song(cuid: "", title: "The Chain", artist: "Fleetwood Mac", album: "Rumours", albumArt: nil, duration: 271, color: .blue),
    Song(cuid: "", title: "Dreams", artist: "Fleetwood Mac", album: "Rumours", albumArt: nil, duration: 257, color: .blue),
    Song(cuid: "", title: "Go Your Own Way", artist: "Fleetwood Mac", album: "Rumours", albumArt: nil, duration: 222, color: .blue),
    Song(cuid: "", title: "Back in Black", artist: "AC/DC", album: "Back in Black", albumArt: nil, duration: 255, color: .black),
    Song(cuid: "", title: "Hells Bells", artist: "AC/DC", album: "Back in Black", albumArt: nil, duration: 312, color: .black),
    Song(cuid: "", title: "Thriller", artist: "Michael Jackson", album: "Thriller", albumArt: nil, duration: 357, color: .orange),
    Song(cuid: "", title: "Billie Jean", artist: "Michael Jackson", album: "Thriller", albumArt: nil, duration: 294, color: .orange),
    Song(cuid: "", title: "Beat It", artist: "Michael Jackson", album: "Thriller", albumArt: nil, duration: 258, color: .orange),
    Song(cuid: "", title: "Time", artist: "Pink Floyd", album: "The Dark Side of the Moon", albumArt: nil, duration: 413, color: .indigo),
    Song(cuid: "", title: "Money", artist: "Pink Floyd", album: "The Dark Side of the Moon", albumArt: nil, duration: 382, color: .indigo),
    Song(cuid: "", title: "Come Together", artist: "The Beatles", album: "Abbey Road", albumArt: nil, duration: 259, color: .cyan),
    Song(cuid: "", title: "Here Comes the Sun", artist: "The Beatles", album: "Abbey Road", albumArt: nil, duration: 185, color: .cyan),
    Song(cuid: "", title: "Stairway to Heaven", artist: "Led Zeppelin", album: "Led Zeppelin IV", albumArt: nil, duration: 482, color: .brown),
    Song(cuid: "", title: "Rock and Roll", artist: "Led Zeppelin", album: "Led Zeppelin IV", albumArt: nil, duration: 220, color: .brown),
    Song(cuid: "", title: "Hotel California", artist: "Eagles", album: "Hotel California", albumArt: nil, duration: 391, color: .yellow),
    Song(cuid: "", title: "Born to Run", artist: "Bruce Springsteen", album: "Born to Run", albumArt: nil, duration: 270, color: .red),
    Song(cuid: "", title: "Purple Rain", artist: "Prince", album: "Purple Rain", albumArt: nil, duration: 520, color: .purple),
    Song(cuid: "", title: "With or Without You", artist: "U2", album: "The Joshua Tree", albumArt: nil, duration: 296, color: .gray),
    Song(cuid: "", title: "Smells Like Teen Spirit", artist: "Nirvana", album: "Nevermind", albumArt: nil, duration: 301, color: .teal),
]
