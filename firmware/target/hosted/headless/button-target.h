 ...
 *
 * No-button target for the headless host build. Control comes from gRPC.
 * Button enum values must exist for switch statements to compile; none
 * ever fire since button_read_device() always returns 0.
 */
