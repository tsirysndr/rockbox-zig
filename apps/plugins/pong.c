...
#define PONG_QUIT        BUTTON_TOPLEFT
#define PONG_PAUSE       BUTTON_CENTER
#define PONG_LEFT_UP     BUTTON_TOPMIDDLE
#define PONG_LEFT_DOWN   BUTTON_BOTTOMMIDDLE
#define PONG_RIGHT_UP    BUTTON_MIDRIGHT
#define PONG_RIGHT_DOWN  BUTTON_MIDLEFT
